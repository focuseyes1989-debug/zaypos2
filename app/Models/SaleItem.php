...
final class SaleItem extends BaseModel
{
    private int $saleId;
    ...
    private float $fulfilledQuantity = 0.0;
    ...
    public function __construct(array $data)
    {
        ...
        if (
            ...
            throw new InvalidArgumentException(
                'Fulfilled quantity must not exceed sale quantity.'
            );
        }

        $this->unitPrice = $this->nonNegativeDecimal(
            $data['unit_price'] ?? 0,
            'Unit price'
        );
    ...
    public function fulfilledQuantity(): float
    {
