...
final class PurchasePayment extends BaseModel
{
    ...
    public function fill(array $data): self
    {
        ...
        $this->purchaseId = $this->positiveInteger(
            $data['purchase_id'] ?? null,
            'Purchase ID'
        );

        $this->supplierId = $this->positiveInteger(
        ...
        $this->referenceNumber = $this->optionalString(
        ...
        $this->createdBy = $this->optionalPositiveInteger(
            $data['created_by'] ?? null,
            'Created by'
        );

        $this->updatedBy = $this->optionalPositiveInteger(
            $data['updated_by'] ?? null,
            'Updated by'
        );

        $this->deletedBy = $this->optionalPositiveInteger(
    ...
    {
        return self::paymentMethodOptions()[$this->paymentMethod]
            ?? ucfirst(
                str_replace(
                    '_',
                    ' ',
